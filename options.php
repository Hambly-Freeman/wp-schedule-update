...
class TAO_ScheduleUpdate_Options {
   ...
   * @var array
   */
  protected static $_tao_publish_options = [];
...
add_action('admin_init', ['TAO_ScheduleUpdate_Options', 'init']);
add_action('admin_menu', ['TAO_ScheduleUpdate_Options', 'options_page']);
